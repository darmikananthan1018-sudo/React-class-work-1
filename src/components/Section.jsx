...
import videoThumbImg from '../assets/images/video-thumb.jpg';
import happyClientImg from '../assets/images/happyclient-01.jpg';
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="video-thumb">
                <img src={videoThumbImg} alt="Video Thumbnail" />
                            ...
                            <div className="row">
                              <div className="col-lg-7">
                                ...
                                <p>
                                  ...
                                  It is a free download provided by
                              ...
                              <div className="col-lg-5 align-self-center">
                                <img src={happyClientImg} alt="Happy Client" />
                              </div>
                            </div>
                          </div>
                        </li>
                          ...
                          <div>
                            <div className="row">
                              <div className="col-lg-7">
                                ...
                                <p>
                                  Lorem ipsum dolor sit amet, consectetur
                                  adipiscing elit, sed doers eiusmod kent
                                  tempor incididunt ut labore et dolore dolor.
                                </p>
                                <div className="info">
                                  <span>SEO Trend</span>
